                    ...
                    <div class="container-fluid">
                        ...
                        <form class="user" action="ControladorCliente">
                            <div class="col-sm-6 mb-3">
                                <p>DNI:</p>
                                <input type="text" class="form-control form-control-user" name="dni" value="<%=clien.getDni()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Nombres:</p>
                                <input type="text" class="form-control form-control-user" name="nombre" value="<%=clien.getNombre()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Apellidos:</p>
                                <input type="text" class="form-control form-control-user" name="apellido" value="<%=clien.getApellido()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Teléfono:</p>
                                <input type="text" class="form-control form-control-user" name="telefono" value="<%=clien.getTelefono()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Correo:</p>
                                <input type="email" class="form-control form-control-user" name="correo" value="<%=clien.getCorreo()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Dirección:</p>
                                <input type="text" class="form-control form-control-user" name="direccion" value="<%=clien.getDireccion()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Fecha de nacimiento:</p>
                                <input type="text" class="form-control form-control-user" name="fechanac" value="<%=clien.getFechanac()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Estado:</p>
                                <input type="text" class="form-control form-control-user" name="estado" value="<%=clien.getEstado()%>">
                            </div>
                            <input type="hidden" name="txtid" value="<%=clien.getIdcliente()%>">
                            <input class="btn btn-primary btn-user btn-block" type="submit" name="accion" value="actualizar">
                            <a class="btn btn-primary btn-user btn-block" href="ControladorCliente?accion=listar">Regresar</a>           
                        </form>
                        <!-- /.container-fluid -->
