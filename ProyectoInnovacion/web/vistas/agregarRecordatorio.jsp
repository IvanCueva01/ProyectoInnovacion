                    ...
                    <div class="container-fluid">
                        ...
                        <form class="user" action="SvRecordatorio">
                            <div class="col-sm-6 mb-3">
                                <p>Mensaje:</p>
                                <input type="text" class="form-control form-control-user" name="mensaje" placeholder="nuevo mensaje">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Autor:</p>
                                <input type="text" class="form-control form-control-user" name="autor" placeholder="autor del mensaje">
                            </div>
