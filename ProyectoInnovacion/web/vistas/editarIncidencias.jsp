            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <p>Aqui se editan las incidencias</p>
                        <%
                            IncidenciaDAO daoinci = new IncidenciaDAO();
                            int id = Integer.parseInt((String) request.getAttribute("idinc"));
                            Incidencia inci = (Incidencia) daoinci.list(id);
                        %>
                        <form class="user" action="ControladorIncidencias?accion=actualizar">
                            <div class="col-sm-6 mb-3">
                                <p>ID cliente:</p>
                                <input type="text" class="form-control form-control-user" name="idcliente" value="<%=inci.getIdcliente()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>ID empleado:</p>
                                <input type="text" class="form-control form-control-user" name="idempleado" value="<%=inci.getIdempleado()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Asunto:</p>
                                <input type="text" class="form-control form-control-user" name="asunto" value="<%=inci.getAsunto()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Detalle:</p>
                                
                                <input type="text" class="form-control form-control-user" name="detalle" value="<%=inci.getDetalle()%>">
                                
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Fecha de registro:</p>
                                <input type="text" class="form-control form-control-user" name="fecharegistro" value="<%=inci.getFecharegistro()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Estado:</p>
                                <input type="text" class="form-control form-control-user" name="estado" value="<%=inci.getEstado()%>">
                            </div>
                             <input type="hidden" name="id" value="<%=inci.getIdinci()%>">
                            <input class="btn btn-primary btn-user btn-block" type="submit" name="accion" value="actualizar">
                            <a class="btn btn-primary btn-user btn-block" href="ControladorIncidencias?accion=listar">Regresar</a>            
                        </form>
                        <!-- /.container-fluid -->
