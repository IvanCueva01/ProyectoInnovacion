            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <p class="mb-4">Visualización de los servicios</p>

                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h2 class="m-0 font-weight-bold text-primary">Lista de Servicios</h2>
                                <a href="ControladorServicio?accion=mostraragregar" class="btn btn-primary btn-user btn-block">Nuevo Servicio</a> 
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <%
                                            ...
                                            List<Servicio> list = daoservi.listar();
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><%=servi.getIdservicio()%></td>
                                                <td><%=servi.getNombre()%></td>
                                                <td><%=servi.getEstado()%></td>
                                                <td style="display:flex;width: 230px">
                                                    <form>
                                                        <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color:yellow; margin-left:5px">
                                                            <a class="fas fa-pencil-alt" href="ControladorServicio?accion=editar&idservicio=<%=servi.getIdservicio()%>">Editar</a>
                                                        </button>
                                                    </form>
                                                    <form>
