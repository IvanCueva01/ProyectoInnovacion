            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <p>Aqui se editarán los usuarios</p>
                        <%
                        ...
                        <form class="user" action="ControladorUsuario">
                            <div class="col-sm-6 mb-3">
                                <p>Usuario:</p>
                                <input type="text" class="form-control form-control-user" name="nombreusu" value="<%=usu.getNombreUsu()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Contraseña:</p>
                                <input type="password" class="form-control form-control-user" name="contrasenia" value="<%=usu.getContrasenia()%>">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <p>Cargo:</p>
                                <input type="text" class="form-control form-control-user" name="cargo" value="<%=usu.getCargo()%>">
                            </div>
                            ...
                            <a class="btn btn-primary btn-user btn-block" href="ControladorUsuario?accion=listar">Regresar</a>
                        </form>
                        <!-- /.container-fluid -->
